...
```bash
nix run ./rielflow -- workflow validate design-and-implement-review-loop
```
...
```bash
nix run ./rielflow -- workflow run design-and-implement-review-loop \
...
```bash
nix run ./rielflow -- workflow run design-and-implement-review-loop \
  --mock-scenario .rielflow/workflows/design-and-implement-review-loop/mock-scenario-planning-only.json \
  --output json
```

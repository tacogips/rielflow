...
export const CHAT_REPLY_WORKER_ADDON_NAME = "rielflow/chat-reply-worker";
export const CHAT_REPLY_WORKER_ADDON_VERSION = "1";
export const CODEX_WORKER_ADDON_NAME = "rielflow/codex-worker";
export const CLAUDE_CODE_WORKER_ADDON_NAME = "rielflow/claude-code-worker";
export const CODEX_SDK_WORKER_ADDON_NAME = "rielflow/codex-sdk-worker";
export const CLAUDE_SDK_WORKER_ADDON_NAME = "rielflow/claude-sdk-worker";
export const CURSOR_SDK_WORKER_ADDON_NAME = "rielflow/cursor-sdk-worker";
export const AGENT_WORKER_ADDON_VERSION = "1";
export const X_GATEWAY_ADDON_NAME = "rielflow/x-gateway";
export const X_GATEWAY_ADDON_VERSION = "1";
export const X_GATEWAY_READ_ADDON_NAME = "rielflow/x-gateway-read";
export const X_GATEWAY_READ_ADDON_VERSION = "1";
export const DEFAULT_X_GATEWAY_IMAGE = "ghcr.io/tacogips/x-gateway:latest";
export const MAIL_GATEWAY_ADDON_NAME = "rielflow/mail-gateway";
export const MAIL_GATEWAY_ADDON_VERSION = "1";
export const MAIL_GATEWAY_READ_ADDON_NAME = "rielflow/mail-gateway-read";

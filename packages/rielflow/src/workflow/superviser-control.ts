...
/** Nested `rielflow/rerun-workflow` accepts auth + session pairing plus optional step rerun only. */
...
export function executeSuperviserControlNativeOperation(input: {
  ...
  switch (input.addonName) {
    ...
    case "rielflow/get-workflow-status": {
    ...
    case "rielflow/get-workflow-execution-details": {
    ...
    case "rielflow/load-workflow-definition": {
    ...
    case "rielflow/save-workflow-definition": {

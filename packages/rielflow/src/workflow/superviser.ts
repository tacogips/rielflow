 ...
 * `WorkflowRunOptions.nestedSuperviserDriver` is set; native `rielflow/*` add-ons receive
...
/**
 * Resolves `rerunFromStepId` for phase-2 nested `rielflow/rerun-workflow` when the
...
const ENGINE_SUPERVISION_PATCHER_ID = "rielflow/supervision-engine" as const;

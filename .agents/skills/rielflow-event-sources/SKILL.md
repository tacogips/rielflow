...
```bash
rielflow events validate --workflow-root <root> --event-root <event-root>
```
...
```bash
rielflow events serve --workflow-root <root> --event-root <event-root>
```

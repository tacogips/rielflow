class Divedra < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/tacogips/divedra/releases/download/v0.1.0/divedra-0.1.0-darwin-arm64.tar.gz"
      sha256 "411823e1e3fb32d7d4377991b35682b3c482cc11f3010e008d55f67b984db860"
    else
      url "https://github.com/tacogips/divedra/releases/download/v0.1.0/divedra-0.1.0-darwin-x64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/tacogips/divedra/releases/download/v0.1.0/divedra-0.1.0-linux-arm64.tar.gz"
      sha256 "8dae57c84bd16863932af2480c3996bad3388e8cdf63170e63728484cce7392f"
    else
      url "https://github.com/tacogips/divedra/releases/download/v0.1.0/divedra-0.1.0-linux-x64.tar.gz"

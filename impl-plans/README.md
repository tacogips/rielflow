...
| -------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `google-speech-to-text-addon` | 2026-06-06 | `design-node-addon-catalog-and-chat-reply-worker#built-in-rielflowgoogle-speech-to-text`, `architecture#built-in-node-add-on-catalog` |
